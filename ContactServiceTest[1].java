...
public class ContactServiceTest {
    ...
    public void addNewContactException(){
        ...
        Assert.assertEquals("Try again with a valid input", outputStreamCaptor.toString()
                .trim());
    }
    ...
    public void firstNameException(){
        ...
        Assert.assertEquals("Check your ID and try again", outputStreamCaptor.toString()
                .trim());
    }
